    ...
    describe('sync', function() {
        ...
        using('success or error', [
            ...
            it('should fire error or complete events when all of the sync jobs have finished', function() {
                ...
                sinon.collection.stub(app.user, 'load', function(callback) {
                    var error = !options.me ? 'Error!' : void 0;
                    callback(error);
                });
                sinon.collection.stub(app.metadata, 'sync', function(callback) {
                ...
                runs(function() {
                    expect(app.user.load).toHaveBeenCalled();
        ...
        it('should not trigger multiple sync when called multiple times', function() {
            ...
            runs(function() {
                expect(app.user.load).toHaveBeenCalledOnce();
