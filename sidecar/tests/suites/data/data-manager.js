...
describe("DataManager", function() {
    ...
    var metadata, app, dm, copiedUser, sinonSandbox,
        instanceOfError = sinon.match.instanceOf(SUGAR.Api.HttpError),
        instanceOfRequest = sinon.match.instanceOf(SUGAR.Api.HttpRequest);
    ...
    it('should return true for a many to many relationship', function() {
        ...
        var getRelationshipStub = sinonSandbox.stub(app.metadata, 'getRelationship', function() {
            return {
    ...
    using('invalid metadata', [
        ...
        it('should return false', function() {
            ...
            sinonSandbox.stub(app.metadata, 'getRelationship', function() {
                return {
                    relationship_type: 'one-to-many',
                    lhs_module: 'test1',
                    rhs_module: 'test1'
