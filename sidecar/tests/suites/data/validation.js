...
describe("Validation", function() {
    ...
    describe('greater/less than validators', function(){
        ...
        it('should be able to validate greaterThan and lessThan Values', function() {
            ...
            var result = validation.validators.greaterThan(intField, 10);
            expect(result).toBeUndefined();

            var result = validation.validators.lessThan(intField, 5);
            expect(result).toBeUndefined();

            result = validation.validators.greaterThan(intField, 0);
            expect(result).toEqual(1);

            var result = validation.validators.lessThan(intField, 1);
            expect(result).toBeUndefined();
        });
    });
    ...
    describe("'email' validator", function() {
        ...
        it("should be able to validate properly formatted emails", function() {
        ...
        it("should be able to invalidate improperly formatted emails", function() {
    ...
    describe("'isAftere' validator", function() {
        var result,
