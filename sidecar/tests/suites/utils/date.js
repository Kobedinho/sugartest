...
describe('Date', function() {
	...
	it("should parse date strings into javascript date objects", function() {
        ...
        it('should return the same Date object', function() {
            ...
            var result = app.date.parse(dateObj);
	...
	it("should convert into relative time", function() {
		var ts                      = new Date().getTime(),
            ...
            LBL_TIME_UNTIL_SECONDS    = new Date(ts + 10*1000),
            LBL_TIME_UNTIL_MINUTE     = new Date(ts + 70*1000),
            LBL_TIME_UNTIL_MINUTES    = new Date(ts + 130*1000),
            LBL_TIME_UNTIL_HOUR       = new Date(ts + 3610*1000),
            LBL_TIME_UNTIL_HOURS      = new Date(ts + 7230*1000),
            LBL_TIME_UNTIL_DAY        = new Date(ts + 90000*1000),
            LBL_TIME_UNTIL_DAYS       = new Date(ts + 200000*1000),
            LBL_TIME_UNTIL_YEAR       = new Date(ts + 400*84600*1000);
        ...
        //Time "Until"
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_SECONDS).str).toEqual("LBL_TIME_UNTIL_SECONDS");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_MINUTE).str).toEqual("LBL_TIME_UNTIL_MINUTE");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_MINUTES).str).toEqual("LBL_TIME_UNTIL_MINUTES");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_HOUR).str).toEqual("LBL_TIME_UNTIL_HOUR");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_HOURS).str).toEqual("LBL_TIME_UNTIL_HOURS");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_DAY).str).toEqual("LBL_TIME_UNTIL_DAY");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_DAYS).str).toEqual("LBL_TIME_UNTIL_DAYS");
        expect(app.date.getRelativeTimeLabel(LBL_TIME_UNTIL_YEAR).str).toEqual("LBL_TIME_UNTIL_YEAR");
	});
    ...
    it("should return +1 day when hour returned is single digit", function() {
        var actual = app.date.parseDisplayDefault('+1 day&4:30am', new Date('January 2, 2012'));
        expect(actual.getHours()).toEqual(4);
        var actual = app.date.parseDisplayDefault('+1 day&4:30pm', new Date('January 2, 2012'));
    ...
    describe('compare()', function() {
        ...
        it('should return -1 when date1 < date2', function() {
            date1 = '2013-01-10';
            date2 = '2013-01-15';
            result = app.date.compare(date1, date2);
        ...
        it('should throw an exception when dates are invalid', function() {
            ...
            expect(function() {
                app.date.compare(date1, date2);
            }).toThrow(new app.date.InvalidException('Invalid date passed for comparison.', date1));
	...
	describe('isAfter()', function() {
		...
		it('should return true when date1 is after date2', function() {
			date1 = new app.date('2016-08-08');
			date2 = new app.date('2016-08-07');
    ...
    describe('isBetween()', function() {
        ...
        it('should return true when date1 is between startDate & endDate', function() {
            ...
            endDate = '2013-01-31';
            result = app.date(date1).isBetween(startDate, endDate);
            expect(result).toBeTruthy();
        });
        ...
        it('should return false when date1 is not between startDate & endDate without inclusive', function() {
            ...
            startDate = '2013-01-01';
            endDate = '2013-01-31';
            result = app.date(date1).isBetween(startDate, endDate, false);
            expect(result).toBeFalsy();
        });
    ...
    describe('duration format()', function() {
        it('should return string representation of the duration in days, hours, and minutes', function() {
            var duration = app.date.duration(7, 'days');
            duration.add(app.date.duration(7, 'hours'));
            duration.add(app.date.duration(7, 'minutes'));
        ...
        it('should return singular nouns when referring to 1 day, hour, and minute', function() {
            var duration = app.date.duration(1, 'days');
            duration.add(app.date.duration(1, 'hours'));
            duration.add(app.date.duration(1, 'minutes'));
        ...
        it('should not return days if not specified.', function() {
            var duration = app.date.duration(7, 'hours');
            duration.add(app.date.duration(7, 'minutes'));
        ...
        it('should return the correct days even when it is more than 31.', function() {
            var duration = app.date.duration(62, 'days');
            duration.add(app.date.duration(7, 'hours'));
            duration.add(app.date.duration(5, 'minutes'));
