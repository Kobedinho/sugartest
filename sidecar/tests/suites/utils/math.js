...
describe('Math', function() {
    ...
    using('isDifferentWithPrecision with precision less than 2',
        ...
        function(precision) {
            it('should calculate correctly', function() {
                app.user.setPreference('decimal_precision', precision);
                ...
                app.user.setPreference('decimal_precision', null);
            });
        }
    );
    ...
    using('isDifferentWithPrecision with precision greater than 1',
        ...
        function(precision) {
            it('should calculate correctly', function() {
                app.user.setPreference('decimal_precision', precision);
                var math_precision = precision-1;
                expect(math.isDifferentWithPrecision(100.00, 100.00)).toBeFalsy();
                expect(math.isDifferentWithPrecision((100+(0.1/Math.pow(10,precision))), (100+(0.1/Math.pow(10,precision))))).toBeFalsy();
                expect(math.isDifferentWithPrecision((100+(0.1/Math.pow(10,math_precision))), 100.00)).toBeTruthy();
                expect(math.isDifferentWithPrecision((100+(0.9/Math.pow(10,precision))), 100.00)).toBeTruthy();
                expect(math.isDifferentWithPrecision((100+(0.1/Math.pow(10,math_precision))), (100+(0.2/Math.pow(10,math_precision))))).toBeTruthy();
                expect(math.isDifferentWithPrecision((100+(0.9/Math.pow(10,precision))), (100+(0.2/Math.pow(10,math_precision))))).toBeTruthy();
                app.user.setPreference('decimal_precision', null);
            });
        }
    );
