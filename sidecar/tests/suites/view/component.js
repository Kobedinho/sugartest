...
describe('View.Component', function() {
    ...
    it('should return false for show if the event should not be triggered', function() {
        ...
        var stubTrigger = sinon.stub(layout, 'triggerBefore', function() {
            return false;
        });

        var stubVisible = sinon.stub(layout, 'isVisible', function() {
            return false;
        });
